...
class PostRow extends React.Component {
    render () {
        ...
        if (post.hero_image.thumbnail) {
            thumbnail = <img src={post.hero_image.thumbnail} alt="Post Thumbnail" />
        } else {
            thumbnail = '-'
        }
        return <tr>
            ...
            results: [
                {
                    ...
                    'hero_image': {
                        'thumbnail': '/media/__sized__/hero_images/292043557_5288107254635656_2490366114391249440_n-crop-c0-5__0-5-200x200-70.jpg',
